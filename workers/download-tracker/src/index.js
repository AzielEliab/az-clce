...
<section class="cite" id="cite">
  ...
  <p><a href="https://aziel-runtime.vibelock.workers.dev/">Catalog</a> · <a href="https://github.com/AzielEliab/az-clce">GitHub</a> · <a href="https://azclce-download-tracker.vibelock.workers.dev/download">Download</a> · <a href="https://azclce-download-tracker.vibelock.workers.dev/cite.json">cite.json</a></p>
</section>
<!-- /gitbaby-seo -->
</body>
</html>`;
...
export default {
  async fetch(request, env) {
    ...
    if ((url.pathname === "/cite.json" || url.pathname === "/cite.json/") && request.method === "GET") {
      return json({"author": "Aziel Eliab", "title": "AZ-CLCE", "github": "https://github.com/AzielEliab/az-clce", "download": "https://azclce-download-tracker.vibelock.workers.dev/download", "doi": null, "license": "Apache-2.0", "catalog": "https://aziel-runtime.vibelock.workers.dev/"});
    }
    // /gitbaby-seo-routes
